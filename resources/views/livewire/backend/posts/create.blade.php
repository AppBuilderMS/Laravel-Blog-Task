...
<div class="row justify-content-center">
    <div class="col-9">
        <div class="card">
            <h5 class="card-header border-bottom text-uppercase bg-primary bg-soft text-primary">Create New Post</h5>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group mb-2" wire:ignore>
                                <label>Content</label>
                                <textarea id="editor-create-content" class="form-control" wire:model="content"></textarea>
                            </div>
                            @error('content')
    ...
    <script>
        @if(auth()->user()->isAdmin())
            $(document).ready(function() {
                $('#editor-create-content').summernote({
