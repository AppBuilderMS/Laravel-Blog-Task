<div class="row justify-content-center">
    <div class="col-12">
        <div class="card">
            ...
            @else
                <h5 class="card-header border-bottom text-uppercase bg-primary bg-soft text-primary">All Posts For {{auth()->user()->name}}</h5>
            @endif
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        @else
                            <h6 class="mb-0">All Posts For {{auth()->user()->name}}</h6>
                        @endif
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="">Archived At</span>
                                            <span class="cursor-pointer" wire:click.prevent="sortBy('deleted_at')">
                                ...
                                @if($allPosts->count() > 0)
                                    @foreach($allPosts as $index => $post)
                                        <tr>
                                            ...
                                            <td>{{$post->deleted_at->format('Y-m-d')}}</td>
                                            <td>
                                                <a href="#" class="btn btn-warning waves-effect" wire:click.prevent="restorePost({{$post->id}})">Restore</a>
                                                <a href="#" class="btn btn-danger waves-effect" wire:click.prevent="forceDeletePost({{$post->id}})">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
